...
const nebulaShared: ProductExtraData = {
    ...
    framing: [
        "A simple white frame (50x70, 500x700 mm) with a frame width no wider than 20 mm is recommended. This clean style lets the artwork shine, with the print fitting directly into the frame — no extra mounting needed.",
