  ...
  return (
    ...
    >
      <footer className={footerStyles.footer}>
        <div>
          <p className={footerStyles.copyright}>© 2021, ANDREA DIOTALLEVI</p>
        </div>
        <div style={{ display: "flex", marginLeft: "25px" }}>
          <div>
            ...
            >
              <span className={footerStyles.iconFallbackText}>Instagram</span>
              <svg
                ...
                style={{ display: "block", marginRight: "25px" }}
              >
          ...
          <div>
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 28 24"
                xmlns="http://www.w3.org/2000/svg"
                style={{ display: "block", marginRight: "21px" }}
              >
